...
/// Get metrics
#[cfg_attr(feature = "otel", instrument(skip_all, fields(operation = "knhk.metrics.get")))]
...
#[cfg_attr(feature = "otel", instrument(skip_all, fields(operation = "knhk.metrics.weaver.start")))]
#[verb]
fn weaver_start(
...
#[cfg_attr(feature = "otel", instrument(skip_all, fields(operation = "knhk.metrics.weaver.stop")))]
#[verb]
...
#[cfg_attr(feature = "otel", instrument(skip_all, fields(operation = "knhk.metrics.weaver.validate")))]
#[verb]
fn weaver_validate(
    registry: Option<String>,
    otlp_port: Option<u16>,
