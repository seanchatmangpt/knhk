...
fn test_receipt_merging_properties() {
    ...
    assert!(
        result.passed,
        "Receipt merging properties should be valid: {}",
        result.message
    );
}
...
fn test_iri_hashing_properties() {
    ...
    assert!(
        result.passed,
        "IRI hashing properties should be valid: {}",
        result.message
    );
}
...
fn test_guard_constraints() {
    ...
    assert!(
        result.passed,
        "Guard constraints should be valid: {}",
        result.message
    );
}
...
fn test_hot_path_performance() {
    ...
    assert!(
        result.passed,
        "Hot path performance should be valid: {}",
        result.message
    );
}
