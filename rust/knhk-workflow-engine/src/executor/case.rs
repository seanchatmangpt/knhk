...
impl WorkflowEngine {
    ...
    pub fn execute_case(
        ...
        Box::pin(async move {
            ...
            if let Some(ref fortune5) = self_ref.fortune5_integration {
            ...
            let spec = self_ref.specs.get(&spec_id).ok_or_else(|| {
            ...
            super::workflow_execution::execute_workflow(self_ref, case_id, &spec_clone).await?;
